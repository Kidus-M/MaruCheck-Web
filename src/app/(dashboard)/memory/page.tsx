...
export default async function MemoryPage() {
  ...
  return (
    <div className="page-stack">
      <PageHeader
        action={<PrimaryLink href="/memory/new">Record memory</PrimaryLink>}
        description="Confirmed failures that should change how future work is verified."
        eyebrow="Knowledge / QA memory"
        title="QA memory"
      />
      <section className="memory-search panel">
        <Icon name="search" />
        <label>
          <span className="sr-only">Search QA memory</span>
          <input placeholder="Search bugs, root causes, files, contracts, or tags" />
        </label>
        <kbd>⌘ K</kbd>
      </section>
