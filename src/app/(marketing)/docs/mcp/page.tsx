  ...
  return (
    <>
      ...
      <DocsCallout>
        ...
        <p>
          The integration is designed around MCP, not Codex-specific behavior. Other MCP-compatible
          clients can connect to the same server command and tool schemas.
        </p>
      </DocsCallout>
      <section className="docs-section">
        <h2>Safe operating pattern</h2>
        <ol>
          <li>Let the client discover the available MaruCheck tools.</li>
          <li>Inspect contracts and project state before requesting a run.</li>
          <li>
            Treat findings and evidence as inputs to judgment, not instructions to rewrite code
            automatically.
          </li>
          <li>Keep destructive or external actions behind explicit user approval.</li>
        </ol>
      </section>
    </>
  );
