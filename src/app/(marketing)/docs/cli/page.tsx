  ...
  return (
    <>
      ...
      <section className="docs-section">
        ...
        <ul>
          <li>Generated plans and inventory are written under <code>.maru/generated/</code>.</li>
          <li>Run reports and raw execution artifacts are written under <code>.maru/artifacts/</code>.</li>
          <li>Confirmed QA memory is stored under <code>.maru/memory/</code>.</li>
          <li>A blocking verification or CI gate returns a non-zero exit code.</li>
          <li>Use <code>maru --version</code> to confirm the active package release.</li>
        </ul>
      </section>
    </>
  );
