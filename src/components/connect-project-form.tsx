    ...
    return (
      <section className="connect-success panel" aria-live="polite">
        <header className="connect-success__header">
          ...
          <span className="connection-state"><i /> Awaiting first report</span>
        </header>
        ...
        <div className="connect-success__grid">
          ...
          <aside className="handoff-steps">
            ...
            <ol>
              <li><span>1</span><p><strong>Store the token</strong><small>Encrypted CI secret · never commit it</small></p></li>
              <li><span>2</span><p><strong>Run MaruCheck in CI</strong><small>Execution remains inside the repository</small></p></li>
              <li><span>3</span><p><strong>Send report.json</strong><small>Only configured metadata and references</small></p></li>
            </ol>
          </aside>
        </div>
    ...
    <section className="connect-console panel">
      <aside className="connect-rail" aria-label="Connection sequence">
        <div className="connect-rail__mark">
          <span><Icon name="branch" /></span>
          <p><strong>GitHub repository</strong><small>Manual connection</small></p>
        </div>
        <ol>
          <li className="is-active"><span>01</span><p><strong>Identify</strong><small>Name the source of proof</small></p></li>
          <li><span>02</span><p><strong>Authorize</strong><small>Create a scoped credential</small></p></li>
          <li><span>03</span><p><strong>Verify</strong><small>Await the first report</small></p></li>
        </ol>
        <div className="connect-rail__boundary">
          <span aria-hidden="true">◉</span>
          <p><strong>Source stays put.</strong><small>MaruCheck receives verification metadata, not repository code.</small></p>
        </div>
      </aside>
      ...
      <form action={action} className="connect-form">
        <header>
          ...
          <p>Use the name engineers already recognize. You can configure GitHub automation after the credential is created.</p>
        </header>

        <div className="connect-provider">
          <span className="connect-provider__icon"><Icon name="branch" /></span>
          <span><strong>GitHub</strong><small>Repository metadata + CI report ingestion</small></span>
          <b>Selected</b>
        </div>

        <div className="connect-fields">
          <label>
            <span>Project name <small>Shown throughout MaruCheck</small></span>
            <input autoComplete="off" name="name" placeholder="maru-web" required />
          </label>
          <label>
            <span>Repository <small>owner/repository</small></span>
            <div className="input-prefix"><span>github.com/</span><input autoComplete="off" name="repository" placeholder="Kidus-M/MaruCheck-Web" required /></div>
          </label>
          <label>
            <span>Production branch <small>Used as the default baseline</small></span>
            <div className="input-prefix input-prefix--branch"><span><Icon name="branch" /></span><input defaultValue="main" name="branch" required /></div>
          </label>
        </div>
        ...
        <footer>
          <p><span aria-hidden="true">◌</span> A project-scoped token will be generated next.</p>
      ...
      <aside className="connect-preview">
        ...
        <div className="connect-preview__flow">
          ...
          <span><i /> MaruCheck</span>
        </div>
        <dl>
          <div><dt>Verification result</dt><dd>Passed / blocked</dd></div>
          <div><dt>Risk score</dt><dd>0–100 + reasons</dd></div>
          <div><dt>Evidence</dt><dd>Metadata + artifact refs</dd></div>
          <div><dt>Source code</dt><dd className="is-denied">Never uploaded</dd></div>
          <div><dt>Repository secrets</dt><dd className="is-denied">Never uploaded</dd></div>
        </dl>
